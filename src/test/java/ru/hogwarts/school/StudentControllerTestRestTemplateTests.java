...
public class StudentControllerTestRestTemplateTests {
    ...
    public void findByIdTestPositive() throws Exception {
        ...
        UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(url);
        Student student = this.testRestTemplate
                .getForObject(builder.toUriString(), Student.class);
        Assertions
                .assertThat(student).isEqualTo(studentOne);
    }
    ...
    public void searchByAgeTestPositive() throws Exception {
        ...
        Assertions
                .assertThat(list.get(0)).isEqualTo(studentOne);
    }
    ...
    public void searchBetweenAgeTestPositive() throws Exception {
        ...
        Assertions
                .assertThat(list.get(0)).isEqualTo(studentOne);
        Assertions
                .assertThat(list.get(1)).isEqualTo(studentTwo);
    }
    ...
    public void getStudentFacultyPositive() throws Exception {
        ...
        UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(url);
        Faculty faculty = this.testRestTemplate.getForObject(builder.toUriString(), Faculty.class);
        System.out.println("faculty = " + faculty);
        Assertions
                .assertThat(faculty).isEqualTo(studentOne.getFaculty());
    }
